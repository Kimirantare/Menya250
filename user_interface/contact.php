...
<head>
  ...
  <title>Menya250 | Contact Us</title>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="active" href="features.html">Learn With Us</a></li>
        </ul>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                ...
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Feel free to reach out for any inquiry, comment or suggestion.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4 ms-auto order-2" data-aos="fade-up">
            <ul class="list-unstyled">
              <li class="mb-3">
                ...
                <span>KN 3 Ave, Nyarugenge, Kigali - Rwanda</span>
              </li>
              <li class="mb-3">
                <strong class="d-block mb-1">Phone</strong>
                <span>(+250) 780 950 654</span>
              </li>
              <li class="mb-3">
                <strong class="d-block mb-1">Email</strong>
                <span>menya250@gmail.com</span>
              </li>
            </ul>
          </div>
