...
<head>
  ...
  <title>Menya250 | Learn With Us</title>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Learn With Menya250</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Revisions made more fun!</p>
              </div>
            </div>
          </div>
        </div>
